...
namespace App.Generation.DungeonGenerator.Runtime.DungeonGenerators.Generation.RoomsSeparator
{
    public class SeparateRoomsDungeonGenerator : IDungeonGenerator
    {
        ...
        public bool Separate(DungeonGenerationResult dungeonGenerationResult, SeparateRoomsGenerationConfig config)
        {
            ...
            // For each room
            foreach (var room in dungeonGenerationResult.GenerationData.GenerationRooms.Rooms)
            {
                // The total direction to move in
                Vector2 seperationDirection = new Vector2();
                // var seperationDirection = new Vector2Int();

                foreach (var otherRoom in dungeonGenerationResult.GenerationData.GenerationRooms.Rooms)
                {
        ...
        public void SeparateRectangles(DungeonGenerationResult dungeonGenerationResult, int maxIterations = 5000, float separationForce = 0.2f,
            int minDistance = 1)
        {
            var rectangles = dungeonGenerationResult.GenerationData.GenerationRooms.Rooms;
        ...
        /// </summary>
        private static Vector2 CalculateSeparationVector(DungeonGenerationRoom rect1, DungeonGenerationRoom rect2, int minDistance,
        ...
        /// </summary>
        private static int GetOverlapX(DungeonGenerationRoom rect1, DungeonGenerationRoom rect2)
        {
        ...
        /// </summary>
        private static int GetOverlapY(DungeonGenerationRoom rect1, DungeonGenerationRoom rect2)
        {
        ...
        /// </summary>
        private static float GetRequiredSeparationDistance(DungeonGenerationRoom rect1, DungeonGenerationRoom rect2,
            Vector2 direction)
        {
        ...
        public void SeparateRectanglesWithGrid(DungeonGenerationResult dungeonGenerationResult, int gridSize = 1, int padding = 1)
        {
            var rectangles = dungeonGenerationResult.GenerationData.GenerationRooms.Rooms;
        ...
        /// </summary>
        public static void SeparateRectanglesInteger(List<DungeonGenerationRoom> rectangles, int maxIterations = 50,
            int minDistance = 1)
        {
            if (rectangles == null || rectangles.Count < 2)
                return;
        ...
        private static (int x, int y) FindBestGridPosition(DungeonGenerationRoom rectangle, HashSet<(int, int)> occupiedCells,
        ...
        private static float GetDistance(DungeonGenerationRoom rect1, DungeonGenerationRoom rect2)
        {
            var center1 = rect1.GetCenter();
            var center2 = rect2.GetCenter();
