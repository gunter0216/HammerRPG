...
namespace App.Generation.DungeonGenerator.Runtime.DungeonGenerators.Generation.Corridors
{
    public class CreateCorridorsDungeonGenerator : IDungeonGenerator
    {
        ...
        private void CreateCorridors(DungeonGeneration generation, SpanningTreeGenerationCash spanningTree)
        {
            ...
            var rooms = dungeon.GenerationData.GenerationRooms.Rooms;
            foreach (var edge in spanningTree.Tree)
            {
                ...
                dungeon.GenerationData.GenerationRooms.Rooms.Add(corridor.GenerationRoom);
            }
        }

        private void SetConnections(DungeonGenerationRoom room1, DungeonGenerationRoom room2, CorridorModel corridor)
        {
            var newRoom = corridor.GenerationRoom;
        ...
        private CorridorModel CreateCorridor(DungeonGenerationRoom room1, DungeonGenerationRoom room2)
        {
            ...
            DungeonGenerationRoom newGenerationRoom;
            if (isHorizontal)
            {
                newGenerationRoom = CreateHorizontal(room1, room2);
            }
            else
            {
                newGenerationRoom = CreateVertical(room1, room2);
            }

            return new CorridorModel(newGenerationRoom, isHorizontal);
            //
        ...
        private DungeonGenerationRoom CreateHorizontal(DungeonGenerationRoom room1, DungeonGenerationRoom room2)
        {
        ...
        private DungeonGenerationRoom CreateVertical(DungeonGenerationRoom room1, DungeonGenerationRoom room2)
        {
