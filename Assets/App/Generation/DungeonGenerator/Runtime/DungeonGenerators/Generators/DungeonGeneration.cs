...
namespace App.Generation.DungeonGenerator.Runtime.DungeonGenerators.Generation
{
    ...
    {
        private readonly DungeonGenerationResult m_DungeonGenerationResult;
        private readonly DungeonGenerationCash m_Cash;
        private readonly DungeonGenerationConfig m_GenerationConfig;

        public DungeonGenerationResult DungeonGenerationResult => m_DungeonGenerationResult;

        public DungeonGeneration(DungeonGenerationResult dungeonGenerationResult, DungeonGenerationConfig generationConfig)
        {
            m_DungeonGenerationResult = dungeonGenerationResult;
