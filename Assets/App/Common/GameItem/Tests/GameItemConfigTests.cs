...
using App.Common.GameItem.Tests.Mock;
using NUnit.Framework;

namespace App.Common.GameItem.Tests
{
    public class GameItemConfigTests
    {
        [Test]
        public void Id_Item_ItemReturned()
        {
            var id = "Item";
            var config = new GameItemConfig(id, 0, Array.Empty<IModuleConfig>());
        ...
        {
            var config = new GameItemConfig(String.Empty, 0, Array.Empty<IModuleConfig>());
        ...
        {
            var config = new GameItemConfig(String.Empty, 1, Array.Empty<IModuleConfig>());
        ...
        {
            var config = new GameItemConfig(String.Empty, 2, Array.Empty<IModuleConfig>());
        ...
        {
            var config = new GameItemConfig(String.Empty, 3, Array.Empty<IModuleConfig>());
        ...
        {
            var config = new GameItemConfig(String.Empty, 0, new IModuleConfig[]
            {
