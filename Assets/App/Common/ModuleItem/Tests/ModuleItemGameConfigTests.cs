...
{
    public class ModuleItemGameConfigTests
    {
        [Test]
        public void Id_Item_ItemReturned()
        {
            var id = "Item";
            var config = new ModuleItemGameConfig(id, 0, Array.Empty<IModuleConfig>());
        ...
        {
            var config = new ModuleItemGameConfig(String.Empty, 1, Array.Empty<IModuleConfig>());
        ...
        {
            var config = new ModuleItemGameConfig(String.Empty, 2, Array.Empty<IModuleConfig>());
        ...
        {
            var config = new ModuleItemGameConfig(String.Empty, 3, Array.Empty<IModuleConfig>());
